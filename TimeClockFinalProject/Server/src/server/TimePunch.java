...
public class TimePunch {
    ...
    /**
     * If the record is marked as not valid, then this date will denote when that 
     * change happened.  For valid records, this field will be null.
     */
    private Date invalidatedDate;

    /**
     * If this record has been invalidated, this field will hold the employee ID of 
     * the person who marked it as invalid.  For valid records, this field will be
     * null.
     */
